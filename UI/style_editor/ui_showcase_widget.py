from PyQt6.QtWidgets import (QWidget, QVBoxLayout, QHBoxLayout, QGridLayout, QLabel, QPushButton, QLineEdit,
                             QCheckBox, QRadioButton, QComboBox, QSlider, QProgressBar,
                             QSpinBox, QDoubleSpinBox, QDateEdit, QTimeEdit, QDateTimeEdit,
                             QListWidget, QTableWidget, QTreeWidget, QTreeWidgetItem, QGroupBox,
                             QTabWidget, QTextEdit, QDial, QPlainTextEdit, QToolButton,
                             QCalendarWidget, QLCDNumber, QFrame, QTableWidgetItem) # Dodano QTableWidgetItem
from PyQt6.QtCore import Qt, QDate, QTime, QDateTime
from PyQt6.QtGui import QIcon, QPixmap, QColor # Dodano QPixmap, QColor
...
class UIShowcaseWidget(QWidget):
    def __init__(self):
        ...
        try:
            ...
            print(f"Nie udało się ustawić ikony dla QToolButton: {e}")
        ...
        layout_numeric.addWidget(QLabel("QSlider (Vertical):"), 3, 0, 1, 1, Qt.AlignmentFlag.AlignTop)
        ...
        layout_numeric.addWidget(QLabel("QDial:"), 4, 0, 1, 1, Qt.AlignmentFlag.AlignTop)
        dial = QDial()
        ...
        layout_text_areas.addWidget(QLabel("QTextEdit:"), 0, 0, Qt.AlignmentFlag.AlignTop)
        text_edit = QTextEdit("To jest <b>QTextEdit</b> z formatowaniem <i>HTML</i>.<br>Można w nim pisać wiele linii.")
        text_edit.setObjectName("SampleTextEdit")
        text_edit.setFixedHeight(100)
        layout_text_areas.addWidget(text_edit, 0, 1)

        layout_text_areas.addWidget(QLabel("QPlainTextEdit:"), 1, 0, Qt.AlignmentFlag.AlignTop)
        plain_text_edit = QPlainTextEdit("To jest QPlainTextEdit.\nObsługuje tylko czysty tekst, ale jest wydajniejszy dla dużych plików.")
        ...
        layout_item_views.addWidget(QLabel("QListWidget:"), 0, 0, Qt.AlignmentFlag.AlignTop)
        ...
        layout_item_views.addWidget(QLabel("QTableWidget:"), 1, 0, Qt.AlignmentFlag.AlignTop)
        ...
        layout_item_views.addWidget(QLabel("QTreeWidget:"), 2, 0, Qt.AlignmentFlag.AlignTop)
        tree_widget = QTreeWidget()
        tree_widget.setHeaderLabels(["Nazwa", "Wartość", "Opis"])
        parent_item1 = QTreeWidgetItem(tree_widget, ["Element Główny 1", "W1", "Opis G1"])
        ...
        preview_tabs.setObjectName("SampleTabWidgetInShowcase") # Unikalna nazwa obiektu
