...
class ResourceManager(QObject):
    ...
    def load_all_resources(self):
        ...
        logger.info("Rozpoczynam ładowanie wszystkich zasobów...")
    ...
    def invalidate_cache(self, resource_name=None):
        ...
        logger.info(f"Cache invalidated for {resource_name or 'all resources'}")

    def cleanup(self):
        """Czyszczenie zasobów przed zamknięciem aplikacji."""
        self.async_loader.cancel_all()
        self.async_loader.cleanup()
        logger.debug("ResourceManager cleaned up")
